...
namespace MoviesApi.İnfrastructure.RedisCache
{
    public class RedisCacheService : IRedisCacheSercice
    {

        private readonly ConnectionMultiplexer redşsConnection;
        ...
        public RedisCacheService(IOptions<RedisCacheSettings> options)
        {
            ...
            redşsConnection = ConnectionMultiplexer.Connect(opt);
            database = redşsConnection.GetDatabase();
        }
